...
def run_ic(session) -> dict:
    from .ic import run_ic_studies
    out = run_ic_studies(session)
...
def run_factors(session) -> dict:
    from .factor_portfolio import run_factor_studies
    out = run_factor_studies(session)
...
def run_baserates(session) -> dict:
    from .base_rates import run_all_studies
    out = run_all_studies(session)
